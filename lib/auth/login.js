...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Google / Facebook sign-ups never set a password. Calling bcrypt.compare
    // with undefined throws "Illegal arguments: string, undefined".
    // Detect this early and return a clear, actionable error.
